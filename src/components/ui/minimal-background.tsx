...
export default function MinimalBackground({ className = "" }: { className?: string }) {
  ...
  return (
    <div className={`absolute inset-0 overflow-hidden pointer-events-none minimal-bg-root ${className}`}>
      <style>{`
.minimal-bg-root {
  --border: #27272a;
}
