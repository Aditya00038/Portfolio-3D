  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      try {
        ...
        console.warn('Failed to retrieve WebGL context from canvas in PixelBlast:', e);
      }

      if (!glContext || !glContext.getContextAttributes()) {
        console.warn('WebGL is not supported or WebGL context limit has been reached. PixelBlast will not be rendered.');
        return;
      }
      ...
      try {
        ...
        console.warn('THREE.WebGLRenderer creation failed in PixelBlast:', e);
        return;
      }
      ...
      try {
        ...
        console.warn('Postprocessing composer failed to initialize in PixelBlast, falling back to standard renderer:', e);
        composer = null;
        touch = null;
        liquidEffect = null;
      }
