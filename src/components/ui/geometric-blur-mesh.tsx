...
export default function GeometricBlurMesh({ className = "" }) {
    ...
    return (
        <div ref={containerRef} className={`relative w-full h-full cursor-pointer overflow-hidden rounded-xl ${className}`}>
            <canvas 
                ref={canvasRef}
                className="w-full h-full"
            />
            <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 pointer-events-none text-center hidden">
                <div className="text-white/20 text-[10px] font-light tracking-widest">
