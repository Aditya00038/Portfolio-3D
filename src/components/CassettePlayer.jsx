        ...
        <div className="flex-1 flex justify-between items-center gap-1.5 px-0.5">
          ...
          <div className="flex-1 flex flex-col items-center gap-1">
            ...
            <button 
              ...
              className={`w-full aspect-[1.25] rounded-[6px] border-t border-l border-t-[#4c4c52] border-l-[#3a3a3e] border-b border-r border-b-[#0b0b0c] border-r-[#0b0b0c] cursor-pointer flex items-center justify-center transition-all duration-150 select-none ${
                activeBtn === 'stop'
        ...
        <div className="flex items-center gap-1.5 pl-2 pr-0.5 border-l border-zinc-950 select-none">
          ...
          <span 
            className={`w-2 h-2 rounded-full transition-all duration-300 ${
              activeBtn === 'play' ? 'bg-[#00ff66] shadow-[0_0_6px_#00ff66]' : 'bg-[#154622]'
            }`} 
          />
        </div>
